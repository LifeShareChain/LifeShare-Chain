...
int64 nChainStartTime = 1523858750;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Ari 16, 2018, Start for LSC coins.";
        CTransaction txNew;
        ...
        printf("block.nNonce = %u \n", block.nNonce);
			block.print();
        assert(block.hashMerkleRoot == uint256("0x1552ac341373e790e25a3012fa52c92bb76b24ecc6981cd4f5dd1924f2352ebf"));
